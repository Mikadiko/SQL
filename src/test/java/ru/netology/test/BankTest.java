...
public class BankTest {
    ...
    void shouldSuccessfulLogin() {
        ...
        var verificationPage = loginPage.validLogin(authInfo); //на странице loginPage ввели валидные данные, нажали
                                                               // кнопку
        verificationPage.verifyVerificationPageVisibility(); //возвратили новую страницу верификации и положили ее в
        // переменную, на странице верификации проверили что видин элемент поле ввода кода, что принимаем как доказ.
        // перехода на страницу верификации
    ...
    @Test
    @DisplayName("Должно появиться уведомление об ошибке, если  с существующим логин в базе и активным пользователем " +
            "и случайным проверочным кодом")
